...
class SSLCSession(SSLCommerz):
    ...
    def set_additional_values(self, value_a: str = '', value_b: str = '', value_c: str = '', value_d: str = '', value_e: str = '', value_f: str = '', value_g: str = '', value_h: str = '') -> None:
        ...
        self.integration_data['value_e'] = value_e
        self.integration_data['value_f'] = value_f
        self.integration_data['value_g'] = value_g
        self.integration_data['value_h'] = value_h
